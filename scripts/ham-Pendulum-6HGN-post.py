...
def main(N=5, dt=1.0e-5, useN=None, withdata=None, datapoints=100, mpass=1, grid=False, stride=1000, ifdrag=0, seed=42, rname=0, saveovito=0, trainm=0, runs=100, semilog=1, maxtraj=100, plotthings=False, redo=0):
    ...
    def _filename(name, tag=TAG, trained=None):
        ...
        if trained is not None:
            psys = f"ham-{trained}-{PSYS.split('-')[2]}"
        else:
            psys = PSYS
