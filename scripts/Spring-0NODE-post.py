...
from src.md import *
from src.models import MSE, initialize_mlp, forward_pass, SquarePlus
...
# plotthings=True
# redo=0
def main(N=5, dt=1.0e-3, useN=None, withdata=None, datapoints=None, stride=100, ifdrag=0, seed=42, rname=0, saveovito=0, trainm=0, runs=200, semilog=1, maxtraj=100, plotthings=False, redo=0):
