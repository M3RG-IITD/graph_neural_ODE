...
def main(N=5, dt=1.0e-3, useN=None, withdata=None, datapoints=None, mpass=1, grid=False, stride=100, ifdrag=0, seed=42, rname=0, saveovito=0, trainm=0, runs=200, semilog=1, maxtraj=100, plotthings=False, redo=0):
    ...
    def graph_force_fn(params, graph):
        _GForce = a_mcgnode_cal_force_q_qdot(params, graph, eorder=None,
                            useT=True)
        return _GForce
    ...
    params = loadfile(f"fgnode_trained_model.dil", trained=useN)[0]
