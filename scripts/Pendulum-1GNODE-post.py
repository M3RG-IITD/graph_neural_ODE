...
def main(N=2, dim=2, dt=1.0e-5, useN=2, stride=1000, ifdrag=0, seed=42, rname=0,  saveovito=0, trainm=0, runs=100, semilog=1, maxtraj=100, plotthings=False, redo=0):
    ...
    def graph_force_fn(params, graph):
        _GForce = gnode_cal_force_q_qdot(params, graph, eorder=eorder,
                            useT=True)
        return _GForce
