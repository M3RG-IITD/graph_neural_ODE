...
def main(N=5, dim=2, dt=1.0e-5, useN=5, stride=1000, ifdrag=0, seed=42, rname=0, withdata=None, saveovito=0, trainm=0, runs=100, semilog=1, maxtraj=100, plotthings=False, redo=0):
